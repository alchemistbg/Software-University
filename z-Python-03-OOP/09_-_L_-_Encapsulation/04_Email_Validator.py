...
class EmailValidator:
    ...
    def __is_name_valid(self, username) -> bool:
    ...
    def validate(self, email) -> bool:
        pattern = r"(\w*)@(\w*).(\w*)"
        username, mail, domain = re.findall(pattern, email)[0]
        return self.__is_name_valid(username) and self.__is_mail_valid(mail) and\
