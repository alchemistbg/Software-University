...
student_card = StudentReportCard("Jane Doe", 1)
student_card.student_name = None
print(student_card.student_name)
student_card.grades_by_subject = {
    'Math': [4, 5, 6],
    'Chemistry': [3, 4, 5]
}
print(student_card.average_grade_by_subject())
