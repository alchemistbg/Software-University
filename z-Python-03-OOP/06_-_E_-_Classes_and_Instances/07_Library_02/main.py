...
# TODO: perform some refactoring where it is possible
...
library.get_book('J.K.Rowling', 'The Chamber of Secrets', 17, user2)
library.get_book('J.K.Rowling', 'The Goblet of Fire', 17, user2)
